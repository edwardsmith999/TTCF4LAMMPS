...
if __name__ == "__main__":
    ...
    rc, _ = run_mother(Nequil=10000, Nruns=0, Ninloop=300, runcounter=0)
    for i in range(nbatches):
        ...
        rc, branchfiles = run_mother(Nequil=0, Nruns=ncpus*1, Ninloop=300, runcounter=rc)
        ...
        pickle.dump([results,dissipations], open("TTCF_run.p","w+"))
